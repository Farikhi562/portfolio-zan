...
export default function SkillsPage() {
  return (
    <div className="bg-slate-50 min-h-screen">
      ...
      <section className="relative pt-28 pb-16 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          ...
          <p className="text-slate-500 text-xl max-w-2xl leading-relaxed">
            Kumpulan teknologi yang saya gunakan untuk membangun produk digital — dari fondasi 
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {skillsData.map((category, i) => {
            ...
            return (
              <div
                key={i}
                className="bg-white p-8 rounded-[1.5rem] border border-slate-200 shadow-sm hover:shadow-lg hover:border-blue-100 transition-all duration-300 card-hover"
              >
                {/* Header */}
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h2 className="font-[family-name:var(--font-syne)] text-xl font-bold text-slate-900">
                      {category.title}
                    </h2>
      ...
      {/* ── CURRENTLY LEARNING ──────────────────────────── */}
      <section className="max-w-6xl mx-auto px-6 pb-16">
        <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-[2rem] p-10 md:p-14 relative overflow-hidden">
          <div className="relative z-10">
            <div className="mb-8">
              ...
              <p className="text-slate-400 mt-2 text-sm">
                Teknologi yang sedang aktif saya pelajari dan eksplor saat ini.
              </p>
            </div>
      ...
      <section className="max-w-6xl mx-auto px-6 pb-20">
        <div className="bg-white border border-slate-200 rounded-[2rem] p-10">
          ...
          <p className="text-slate-400 text-sm mb-8">
            Semua teknologi yang pernah saya gunakan dalam proyek nyata.
          </p>
          <div className="flex flex-wrap gap-3">
            {[
              'Next.js', 'React', 'TypeScript', 'JavaScript', 'Python', 'HTML5', 'CSS3',
              'Tailwind CSS', 'FastAPI', 'Node.js', 'PostgreSQL', 'Supabase', 'MySQL',
              'PyTorch', 'TensorFlow', 'Scikit-learn', 'OpenCV', 'LangChain', 'Pandas',
              'NumPy', 'Matplotlib', 'Seaborn', 'Claude API', 'OpenAI API', 'Jupyter',
              'Docker', 'Git', 'GitHub', 'GitHub Actions', 'Vercel', 'Linux', 'Bash',
              'Nginx', 'Postman', 'Figma', 'VS Code', 'Notion',
            ].map((tech, i) => (
              <span
                key={i}
